...
export const Header = () => {
  ...
  return (
    <header>
      <nav
        className="bg-white border-b-2 border-b-gray
      border-gray-200 dark:border-slate-800 dark:bg-gray-900"
      >
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <img src={Logo} className="h-8 mr-2 sm:h-9" alt="Cineflix Logo" />
